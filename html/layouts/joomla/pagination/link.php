...
switch ((string) $item->text) {
    ...
    case Text::_('JLIB_HTML_START'):
        $icon = $app->getLanguage()->isRtl() ? 'fa fa-arrow-right-to-bracket' : 'fa fa-arrow-left-to-bracket';
    ...
    case $item->text === Text::_('JPREV'):
        ...
        $icon = $app->getLanguage()->isRtl() ? 'fa fa-arrow-right' : 'fa fa-arrow-left';
        $aria = Text::sprintf('JLIB_HTML_GOTO_POSITION', strtolower($item->text));
        break;

    // Check for "Next" item
    case Text::_('JNEXT'):
        $icon = $app->getLanguage()->isRtl() ? 'fa fa-arrow-left' : 'fa fa-arrow-right';
        $aria = Text::sprintf('JLIB_HTML_GOTO_POSITION', strtolower($item->text));
        break;

    // Check for "End" item
    case Text::_('JLIB_HTML_END'):
        $icon = $app->getLanguage()->isRtl() ? 'fa fa-arrow-left-to-bracket' : 'fa fa-arrow-right-to-bracket';
        $aria = Text::sprintf('JLIB_HTML_GOTO_POSITION', strtolower($item->text));
        break;
