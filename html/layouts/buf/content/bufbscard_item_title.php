...
$title_html_header = 'h2';

//leading
if ($displayData->isleading) {
    $title_html_header = $params->get('buf_leading_html_struct', 'h2');
}
//intro
if (!$displayData->isleading) {
    $title_html_header = $params->get('buf_intro_html_struct', 'h2');
}
...
<?php if ($displayData->state == 0 || $params->get('show_title') || ($params->get('show_author') && !empty($displayData->author))) : ?>
    <div class="page-header">
        <?php if ($params->get('show_title')) : ?>
            <<?Php echo $title_html_header; ?> itemprop="name">
