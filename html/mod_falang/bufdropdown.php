...
<div class="mod-languages buf_bs_languages">
    ...
    <div class="dropdown">
        ...
        <?php $langTag = !empty($language->sef) ? $language->sef : null; ?>
        ...
        <?php if ($language->display) { ?>
            ...
            <?php if ($langTag): ?>
            lang="<?php echo htmlspecialchars($langTag, ENT_QUOTES, 'UTF-8'); ?>"
            hreflang="<?php echo htmlspecialchars($langTag, ENT_QUOTES, 'UTF-8'); ?>"
            <?php endif; ?>>
            ...
            <i class="fa-solid fa-check lang_checked"></i>
            <?php endif; ?>
            </a>
